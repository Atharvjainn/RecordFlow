...
>
  <Link href={`/videos/${video.videoId}`} className="block">
    <div className="overflow-hidden rounded-2xl bg-white shadow-md hover:shadow-xl hover:-translate-y-1 duration-200 transition-all group">
      ...
      <div className="relative aspect-video bg-black">
        ...
        {/* Play button */}
        <div className="absolute inset-0 flex items-center justify-center group-hover:scale-103 transition-all">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-black/40 backdrop-blur">
            <svg
              viewBox="0 0 24 24"
              className="h-7 w-7 fill-white translate-x-px"
            >
      ...
      {/* META */}
      <div className="p-4">
        <h3 className="font-semibold text-black leading-snug line-clamp-1">
          {video.title || "New Recording"}
        </h3>
